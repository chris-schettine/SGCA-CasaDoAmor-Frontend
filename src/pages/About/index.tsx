...
const developers = [
    ...
    { name: "Cauê Rodrigues", role: "Frontend, Cloud e Testes", github: "https://github.com/CauAguiar", linkedin: "#", photo: "caue.jpeg" },
    ...
    { name: "João Henrique", role: "Fullstack", github: "https://github.com/henriksson666", linkedin: "#", photo: "" },
                    ...
                    <Grid size={{ xs: 12, md: 8 }}>
                        ...
                        >
                            ...
                            <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap sx={{ mt: 1 }}>
                                <Chip label="React + TypeScript" icon={<CodeIcon />} color="primary" variant="outlined" size="small" role="presentation" />
                                <Chip label="Java Spring Boot" icon={<CodeIcon />} color="primary" variant="outlined" size="small" role="presentation" />
                                <Chip label="MySQL" icon={<CodeIcon />} color="primary" variant="outlined" size="small" role="presentation" />
                                <Chip label="Docker" icon={<CodeIcon />} color="primary" variant="outlined" size="small" role="presentation" />
                                <Chip label="Material UI" icon={<CodeIcon />} color="primary" variant="outlined" size="small" role="presentation" />
                            </Stack>
                        </Paper>
                    </Grid>
