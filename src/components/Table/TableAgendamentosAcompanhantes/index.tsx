...
interface TableAgendamentosAcompanhantesProps {
  agendamentos: AgendamentoAcompanhanteResponse[];
  loading?: boolean;
...
export default function TableAgendamentosAcompanhantes({
  agendamentos,
  loading,
  onView,
  onEdit,
  onCancel,
}: TableAgendamentosAcompanhantesProps) {
